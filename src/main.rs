...
/// A simple square pyramid: 4 base corners + 1 apex, authored in the usual
/// right-handed/Y-up/meters convention (a 2m x 2m base, 1.5m tall).
fn pyramid_mesh() -> pseudocooker::MeshInput {
    let positions = vec![
    ...
    let faces = vec![
        // Base (quad, wound so its normal faces down and out of the pyramid).
        Face {
            material_index: 0,
            corners: vec![
                Corner::new(0),
        ...
        Face {
            material_index: 1,
            corners: vec![Corner::new(0), Corner::new(4), Corner::new(1)],
        },
        Face {
            material_index: 1,
            corners: vec![Corner::new(1), Corner::new(4), Corner::new(2)],
        },
        Face {
            material_index: 1,
            corners: vec![Corner::new(2), Corner::new(4), Corner::new(3)],
        },
        Face {
            material_index: 1,
            corners: vec![Corner::new(3), Corner::new(4), Corner::new(0)],
        },
    ];
    ...
    pseudocooker::MeshInput {
        ...
        normals: Vec::new(),
        faces,
        material_names: vec!["M_Base".to_string(), "M_Sides".to_string()],
    }
}
...
fn main() {
    ...
    // clone Package import
    {
        ...
        new_import.object_name = umap.add_fname("/Game/Mods/Maps/slop/cookout");
    ...
    // clone StaticMesh import
    {
        ...
        new_import.object_name = umap.add_fname("cookout");
        umap.add_import(new_import);
    }
    ...
    */
    ...
    let opt = pseudocooker::CookOptions {
        body_setup_guid: None,
        lighting_guid: None,
        package_guid: None,
    };
    let cooked = pseudocooker::cook(&pyramid_mesh(), "cookout", true, 100.0, &opt);
    pak.write_file("Mods/Maps/slop/cookout.uasset", true, &cooked.uasset).expect("failed to write uasset to pak");
    pak.write_file("Mods/Maps/slop/cookout.uexp", true, &cooked.uexp).expect("failed to write uasset to pak");
